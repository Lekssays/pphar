...
def get_device_id(cuda_is_available):
    subject_id = os.getenv("PPHAR_SUBJECT_ID")
    ...
    mem_dict = {}
    mem_list = []
    if int(subject_id) in range(1,5):
        ...
        if int(subject_id) == 2 or int(subject_id) == 9:
            device_id = 2
    elif int(subject_id) in range(5,10):
        ...
        # else:
        #      device_id=-1
    elif int(subject_id) in range(10,15):
        ...
        # else:
        #      device_id=-1
    elif int(subject_id) in range(15,20):
